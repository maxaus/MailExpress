package com.baev.mailexpress.ui;

import com.baev.mailexpress.util.attachment.FileExtension;
import com.baev.mailexpress.util.attachment.FileType;
 ...
 * @author Maxim Baev
 */
@FacesComponent("com.baev.mailexpress.ui")
public class UIAttachment extends UIComponentBase {

    private static final String COMPONENT_TYPE = "com.baev.mailexpress.ui";
